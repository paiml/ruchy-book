# [BUG] Critical Variable Scoping Regression in v3.213.0 - Top-level statements broken

## Bug Description
Variable scoping is completely broken for top-level (script-style) code in v3.213.0. Each `let` statement gets wrapped in its own block scope, making variables inaccessible to subsequent statements. This represents a **52% failure rate** in the Ruchy Book test suite.
...
| Test Suite | v3.213.0 | v3.213.0 | Regression |
|------------|---------|---------|------------|
...
## References
- Full analysis: [CRITICAL-v3.213.0-scoping-regression.md](https://github.com/paiml/ruchy-book/blob/main/docs/bugs/CRITICAL-v3.213.0-scoping-regression.md)
- Test Suite: https://github.com/paiml/ruchy-book
- Previous similar bug in v3.213.0 (fixed in v3.213.0, regressed in v3.213.0)