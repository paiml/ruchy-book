# 📁 Ruchy v1.0.3 Bug Report Documentation Index
...
### Primary Bug Report
**File**: `/home/noah/src/ruchy-book/docs/bugs/CRITICAL-v1.0.3-transpiler-bugs.md`
...
- **v1.0.3**: 44% (122/280) - Parse-based testing (INACCURATE)
- **v1.0.3**: 45% (126/280) - Parse-based testing (INACCURATE)  
- **v1.0.3**: 4% (10/280) - Compile-based testing (ACCURATE)
...
- **Critical Commit**: `6f47c6d` - "RELEASE v1.0.3: Perfect Language Compatibility Achieved"
...
**Primary Report**: `/home/noah/src/ruchy-book/docs/bugs/CRITICAL-v1.0.3-transpiler-bugs.md`
