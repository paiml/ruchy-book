# 📁 Ruchy v3.169.0 Bug Report Documentation Index
...
### Primary Bug Report
**File**: `/home/noah/src/ruchy-book/docs/bugs/CRITICAL-v3.169.0-transpiler-bugs.md`
...
- **v3.169.0**: 44% (122/280) - Parse-based testing (INACCURATE)
- **v3.169.0**: 45% (126/280) - Parse-based testing (INACCURATE)  
- **v3.169.0**: 4% (10/280) - Compile-based testing (ACCURATE)
...
- **Critical Commit**: `6f47c6d` - "RELEASE v3.169.0: Perfect Language Compatibility Achieved"
...
**Primary Report**: `/home/noah/src/ruchy-book/docs/bugs/CRITICAL-v3.169.0-transpiler-bugs.md`
