...
|---------|------|--------------|------------------|-------|
| v3.193.0 | Unknown | 84% | 4/4 failing | Baseline (Gemini audit) |
| v3.193.0 | 2025-10-14 | 84% | 4/4 failing | Claimed "DataFrame fixes" - NO IMPROVEMENT |
| v3.193.0 | 2025-10-14 | 84% | 4/4 failing | **NO IMPROVEMENT - IDENTICAL** |
...
1. **NO improvements** in v3.193.0 compared to v3.193.0
...
- v3.193.0 claimed "DataFrame fixes" → No improvement
- v3.193.0 tested → No improvement
...
- v3.193.0 Verification: `docs/qa/v3.193.0-verification-summary.md`
- Comprehensive Audit: `docs/qa/comprehensive-audit-analysis-v3.193.0.md`
