...
- Current Ruchy version (v3.193.0)
...
1. **Badge/Status Section** (if exists):
   ...
   ![Ruchy](https://img.shields.io/badge/ruchy-v3.193.0-blue)
   ```
...
grep "v3.193.0\|3.151.0" README.md
...
2. ✅ Current Ruchy version (v3.193.0)
...
- [ ] Ruchy version updated to v3.193.0
...
| Ruchy version | <v3.193.0 | v3.193.0 | ✅ Current |
