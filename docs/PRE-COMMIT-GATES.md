...
**Allowed Historical Versions**: v3.169.0, v3.82.0, v3.67.0
...
2. Update all references: `v1.84.0` → `v3.175.0`
3. Keep historical versions for context (v3.169.0, v3.82.0, v3.67.0)
