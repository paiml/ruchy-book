...
## Previous Status (v3.176.0)

The v3.176.0 benchmark status claimed:
...
- **Issue #116**: File object methods (FIXED in v3.181.0) - Same Message type pattern
- **Issue #117**: JSON API (claimed fixed in v3.176.0) - STILL BROKEN
- **Issue #121**: Result unwrapping (fixed in v3.176.0) - May be related
