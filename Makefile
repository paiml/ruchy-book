...
help:
	...
	@echo "  make test-all-chapters - Test all chapters (1-6)"
...
# Test all chapters including modules, control flow, and data structures
test-all-chapters: test-foundation test-ch04 test-ch05 test-ch06
